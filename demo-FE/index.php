                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item" style="background-image: url('img/hero/banner.png');">
                        <div class="hero__text" style="margin-left: 200px; text-align: center;">
                            <h3 style="color: white; background-color: rgba(56, 49, 56, 0.156); width: 200px; margin-left: 50px; font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">NEXUS</h3>
                ...
                <div class="categories__slider owl-carousel">
                    ...
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-3.jpg">
                            <h5><a href="#">SÁCH GIÁO KHOA</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-4.jpg">
                            <h5><a href="#">TẠP CHÍ</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-5.jpg">
                            <h5><a href="#">SÁCH TIẾNG ANH</a></h5>
                        </div>
                    </div>
                </div>
            </div>
